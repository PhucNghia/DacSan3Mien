namespace DacSan3Mien.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DacSan3Mien.Models.DataContext>
    {
        ...
        protected override void Seed(DacSan3Mien.Models.DataContext context)
        {
            ...
            {
                new Product{name = "Thịt trâu sấy", image = "thit_trau_say.jpg", price = 100000, status = "Còn hàng",
                    ...
                    regionId = 1 },
                new Product{name = "Bánh Đậu Xanh Hải Dương", image = "dau_xanh.jpg", price = 18000, status = "Còn hàng",
                    ...
                    regionId = 1 },
                new Product{name = "Su su Tam Đảo Vĩnh Phúc", image = "su_su.jpg", price = 99000, status = "Còn hàng",
                    ...
                    regionId = 1 },
                new Product{name = "Măng Nứa Tuyên Quang", image = "thit_trau_say.jpg", price = 20000, status = "Còn hàng",
                    ...
                    regionId = 1 },
                new Product{name = "Chè Thái Nguyên", image = "che_thai_nguyen.jpg", price = 50000, status = "Còn hàng",
                    ...
                    regionId = 1 },
                new Product{name = "Gạo nếp nương Điện Biên", image = "nep_nuong.jpg", price = 60000, status = "Còn hàng",
                    ...
                    regionId = 1 },
                new Product{name = "Bánh đa Kế", image = "banh_da_ke.jpg", price = 30000, status = "Còn hàng",
                    ...
                    regionId = 1 },
                new Product{name = "Lạp sườn Fansipan", image = "lap_suon.jpg", price = 120000, status = "Còn hàng",
                    ...
                    regionId = 1 },
                new Product{name = "Thuốc Tắm Dao Đỏ", image = "thuoc_tam_giao_do.jpg", price = 200000, status = "Còn hàng",
                    ...
                    regionId = 1 },
                new Product{name = "Mít sấy hương vị tự nhiên", image = "mit_say.jpg", price = 150000, status = "Còn hàng",
            ...
            {
                new Product{name = "Cu đơ Hà Tĩnh", image = "cu_do.jpg", price = 650000, status = "Còn hàng",
                    ...
                    regionId = 2 },
                new Product{name = "Sá Sùng", image = "sa_sung.jpg", price = 400000, status = "Còn hàng",
                    ...
                    regionId = 2 },
                new Product{name = "Khô gà xé cay", image = "sa_sung.jpg", price = 130000, status = "Còn hàng",
                    ...
                    regionId = 2 },
                new Product{name = "Bánh tráng Bình Định", image = "banh_trang.jpg", price = 70000, status = "Còn hàng",
                    ...
                    regionId = 2 },
                new Product{name = "Viên Hà Thủ Ô", image = "ha_thu_o.jpg", price = 160000, status = "Còn hàng",
                    ...
                    regionId = 2 },
                new Product{name = "Tôm chua nõn nhỏ", image = "tom_chua.jpg", price = 65000, status = "Còn hàng",
                    ...
                    regionId = 2 },
                new Product{name = "Hạt Sen Khô", image = "sen_kho.jpg", price = 30000, status = "Còn hàng",
            ...
            {
                new Product{name = "Muối tôm Tây Ninh", image = "muoi_tom.jpg", price = 55000, status = "Còn hàng",
                    ...
                    regionId = 3 },
                new Product{name = "Thèo lèo Tây Ninh", image = "theo_leo.jpg", price = 20000, status = "Còn hàng",
                    ...
                    regionId = 3 },
                new Product{name = "Nem bưởi", image = "nem_buoi.jpg", price = 650000, status = "Còn hàng",
                    ...
                    regionId = 3 },
                new Product{name = "Nho Phan Giang", image = "nho.jpg", price = 70000, status = "Còn hàng",
                    ...
                    regionId = 3 },
                new Product{name = "Bánh tét Cần Thơ", image = "banh_tet.jpg", price = 80000, status = "Còn hàng",
                    ...
                    regionId = 3 },
                new Product{name = "Bánh Pía Sài Gòn", image = "banh_pia.jpg", price = 10000, status = "Còn hàng",
                    ...
                    regionId = 3 },
                new Product{name = "Rượu Dừa Bến Tre", image = "ruou_dua.jpg", price = 85000, status = "Còn hàng",
